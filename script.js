            ...
            if(r.ResultSet.Found == 1){
                ...
                $.getJSON(weatherYQL.replace('WID',woeid), function(r){
                    ...
                    if(r.query && r.query.count == 1){
                        ...
                        var language = r.query.results.channel.language;
                        if(!item){
                        ...
                        addWeather(item.code, "½ñÌì", item.text + ' <b>'+item.temp+'¡æ</b>');
                        ...
                        for (var i=0;i<2;i++){
                            ...
                            addWeather(
                                ...
                                item.text + ' <b>'+item.low+'¡æ'+' / '+item.high+'¡æ'+'</b>'
                                );
                        }
